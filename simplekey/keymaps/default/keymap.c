...
{
    oled_write_P(led_state.num_lock ? PSTR("NL_ON ") : PSTR("N_OFF "), false);
    oled_write_P(led_state.caps_lock ? PSTR("CP_ON ") : PSTR("C_OFF "), false);
    oled_write_P(led_state.scroll_lock ? PSTR("SR_ON ") : PSTR("S_OFF "), false);
}
